...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{url('createTheatre')}}">
            ...
            <li class="nav-item">
                <a class="nav-link " href="{{url('movieIndex')}}">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow" style="height: 150px;">
                    ...
                    <div>
                        <h2 style="color: gray; padding-left: 20px;">CinePlex<sub> <h6 style="color: gray; padding-left: 0px;">Welcome to {{ Auth::user()->name }} panel</h6></sub></h2>
                    </div>
